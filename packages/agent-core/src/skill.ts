...
export interface AgentSkill {
  ...
  buildContext?(): string
  /**
   * signal: aborted when the user hits stop. Long-running tools should check
   * signal.aborted in their loops and stop promptly.
   */
...
export function composeSkills(id: string, intro: string, skills: AgentSkill[]): AgentSkill {
  ...
  // keyed on runtime capability, and the loop reads
