...
export interface ProviderCapabilities {
  /** Managed providers own OAuth; API-key providers send Bearer credentials. */
 ...
 * `reasoning_content` it produced. Preserve the established direct-provider
 * non-thinking default while supporting reasoning echo for other routes.
 */
...
export const AI_PROVIDER_ADAPTERS: Record<AiProviderId, ProviderAdapter> = {
  ...
  openai: {
    ...
    // other OpenAI-compatible vendors and LM Studio still expect `max_tokens`
