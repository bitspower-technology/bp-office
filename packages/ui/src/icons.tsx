...
import bpofficeMark from './assets/bpoffice-mark.png'
...
/**
 * BP-Office app mark. Rendered from the shipped application icon so the
 * in-app badge always matches the taskbar and installer artwork.
 */
