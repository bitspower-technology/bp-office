...
[BP-Office repository](https://github.com/BP-Arnaud/bp-office). This fork tracks
...
AI features degrade rather than break when LM Studio is offline or ChatGPT is
signed out: errors provide Retry and Open AI Provider Settings actions.
