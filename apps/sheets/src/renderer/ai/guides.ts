...
export const GUIDE_CATALOG: Readonly<Record<string, GuideEntry>> = {
  ...
  'data-attribution': {
    description:
      'Data source attribution: three tracing methods for user-supplied external data — Source column / footer rows / dedicated Sources sheet — plus the decision table',
