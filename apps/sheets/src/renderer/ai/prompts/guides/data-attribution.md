...
When filling a sheet with externally sourced data supplied by the user, leave traceable source citations when source URLs are available. Implement them with `set_hyperlink` + `set_cell` + `format_range`.
...
| User-provided sourced data                 | Required   | Source column                           |
...
[
  { "op": "set_cell", "sheetId": "s1", "address": "A23", "value": "Sources:" },
  {
    ...
    "sheetId": "s1",
    "range": "A23",
    "format": { "bold": true, "italic": true, "fontColor": "#666666" }
  },
  {
    "op": "set_cell",
    "sheetId": "s1",
    "address": "A24",
    "value": "SEC EDGAR - NVIDIA 10-K FY2024"
  },
  { "op": "set_hyperlink", "sheetId": "s1", "address": "A24", "target": "https://sec.gov/..." },
  {
    ...
    "sheetId": "s1",
    "range": "A24:A26",
    "format": { "italic": true, "fontColor": "#0563C1" }
  }
]
```
...
[
  {
    ...
    "sheetId": "sSources",
    "range": "A1:D1",
    "values": [["Data point", "Source", "URL", "Retrieved"]]
  },
  {
    "op": "format_range",
    "sheetId": "sSources",
  ...
  },
  {
    ...
    "sheetId": "sSources",
    "range": "A2:D2",
    "values": [["FY2024 revenue", "SEC 10-K", "https://sec.gov/...", "2026-07-24"]]
  },
