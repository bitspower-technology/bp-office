...
const agentMessageSchema = z.union([
  ...
  z
    .object({
      ...
      reasoning: z.string().max(1_048_576).optional(),
    })
    .strict(),
...
export const aiToolResultRequestSchema = z
  .object({
...
export type AiToolResultRequestInput = z.infer<typeof aiToolResultRequestSchema>
