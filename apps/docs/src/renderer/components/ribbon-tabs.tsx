...
export function ReviewTab({
  ...
  // Editor / Translate send the full document to the configured provider and
      ...
      <div className="ribbon-group">
        <div className="ribbon-group-items">
          <button
            className="rb-big"
            disabled={!hasDoc}
            data-tip={`${t('ribbonEditorTip')} — ${t('ribbonAiProviderNote')}`}
            onClick={() => {
        ...
        <div className="ribbon-group-items">
          <div className="rb-split-wrap">
            <button
              className="rb-big"
              disabled={!hasDoc}
              data-tip={`${t('ribbonTranslateTip')} — ${t('ribbonAiProviderNote')}`}
      ...
      <div className="ribbon-group">
        <div className="ribbon-group-items">
          ...
          <button
            ...
            data-tip={`${t('ribbonAiCommentsTip', { count: openCommentCount })} — ${t('ribbonAiProviderNote')}`}
      ...
      <div className="ribbon-group">
        <div className="ribbon-group-items">
          ...
          <button
            className="rb-big"
            disabled={!hasDoc || revisionCount === 0}
            data-tip={`${t('ribbonAiRevisionsTip', { count: revisionCount })} — ${t('ribbonAiProviderNote')}`}
