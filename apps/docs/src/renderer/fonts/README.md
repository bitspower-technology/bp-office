...
The serif subset also backs the `NiuOffice Fullwidth TC` face (`fonts.css`), a
...
`NiuOfficeCheLatinKR.woff2` is an ASCII-only derivative of NiuOffice Sans KR.
...
| Font                               | Role                                            |
| ---------------------------------- | ----------------------------------------------- |
| NiuOffice Gothic KR (subset woff2) | real-metric face for NanumGothic-declaring docs |
...
`NiuOfficeGothicKR-Regular-subset.woff2`. Renamed per OFL (the upstream
...
| Font                    | Role                                     |
| ----------------------- | ---------------------------------------- |
| NiuOffice Tamil (woff2) | Latha-metric stand-in for Tamil families |
...
| Font                              | Role                                             |
| --------------------------------- | ------------------------------------------------ |
| NiuOffice PUA Blank (woff2, 312B) | blank 1em glyph for all of U+E000-F8FF (BMP PUA) |
