...
The serif subset also backs the `BP-Office Fullwidth TC` face (`fonts.css`), a
...
| Font                                 | Role                                                      |
| ------------------------------------ | --------------------------------------------------------- |
| BP-Office Serif KR (subset woff2)    | Batang-metric stand-in for Korean serif families          |
| BP-Office Sans KR (subset woff2)     | fallback for Korean sans families (Malgun etc.)           |
| BP-Office Che Latin KR (ASCII woff2) | half-width Latin for BatangChe/GulimChe/DotumChe families |
...
`BP-OfficeCheLatinKR.woff2` is an ASCII-only derivative of BP-Office Sans KR.
...
| Font                               | Role                                            |
| ---------------------------------- | ----------------------------------------------- |
| BP-Office Gothic KR (subset woff2) | real-metric face for NanumGothic-declaring docs |
...
`BP-OfficeGothicKR-Regular-subset.woff2`. Renamed per OFL (the upstream
...
| Font                    | Role                                     |
| ----------------------- | ---------------------------------------- |
| BP-Office Tamil (woff2) | Latha-metric stand-in for Tamil families |
...
| Font                              | Role                                             |
| --------------------------------- | ------------------------------------------------ |
| BP-Office PUA Blank (woff2, 312B) | blank 1em glyph for all of U+E000-F8FF (BMP PUA) |
