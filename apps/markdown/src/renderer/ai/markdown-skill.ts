...
const AGENT_SYSTEM_PROMPT = [
  ...
  '',
  '## Images',
  '- An image URL may only be added when the user explicitly supplied that URL. Network search and image generation are unavailable; never invent a URL or claim to have searched.',
  '',
  ...
  '- Never invent facts or numbers. Network search is unavailable, so ask the user for a source when current external information is required.',
  '',
  '## Conversation',
