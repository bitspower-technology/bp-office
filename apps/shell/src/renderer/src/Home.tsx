...
function AiProviderEntry() {
  ...
  const refreshSelected = useCallback(
    async (showChecking = true) => {
      ...
      await refreshLmStudio(undefined, showChecking)
    },
    [refreshLmStudio],
  )
  ...
  const state = lmStudioChecking
    ? 'checking'
    : (lmStudioStatus?.state ?? 'unreachable')
  const statusLabel = lmStudioChecking
    ? t('lmStudioChecking')
    : state === 'connected'
  ...
  return (
    <div className="local-ai-entry">
      ...
      <button
        ...
        data-testid="lmstudio-status-button"
      ...
      >
        ...
        <span className="local-ai-text">
          <span className="local-ai-name">LM Studio</span>
          <span
            className={`local-ai-status ${state}`}
            data-testid="lmstudio-status-text"
          >
            {statusLabel}
          </span>
        </span>
