...
interface Slide {
  ...
  bodyDim?: boolean
  /** community slide shows local AI information with the project-community call-to-action */
  showLocalAi?: boolean
  art: 'logo' | 'gift' | 'check'
}
...
const SLIDES: readonly Slide[] = [
  ...
  { titleKey: 'onbTitle2', subtitleKey: 'onbBody2', showLocalAi: true, art: 'gift' },
  {
    titleKey: 'onbTitle3',
        ...
        <div className="onb-stage">
          {SLIDES.map((s, i) => (
            ...
            >
              ...
              {s.showLocalAi && (
                <div className="onb-local-ai-panel">
                  <p className="onb-local-ai">{renderEmphasis(t('onbLocalAi'))}</p>
