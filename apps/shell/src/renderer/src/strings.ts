...
export const strings = {
  zh: {
    ...
    lmStudioUnreachable: '无法连接 LM Studio',
    lmStudioOpenSettings: '打开本地 AI 设置',
    setSecLocalAi: '本地 AI',
    lmStudioEndpoint: '服务器地址',
    lmStudioEndpointHint: 'LM Studio 的 OpenAI 兼容服务器地址',
    lmStudioModel: '模型',
    lmStudioModelAuto: '自动选择可用模型',
    lmStudioModelAutomatic: '自动',
    lmStudioModelManual: '手动',
    lmStudioModelRequired: '手动选择需要填写模型 ID。',
    lmStudioApiToken: 'API 令牌（可选）',
    lmStudioApiTokenHint: '仅当 LM Studio 服务器要求时填写',
    lmStudioRefresh: '刷新',
    lmStudioSaveTest: '保存并测试',
    lmStudioSaving: '保存中…',
    lmStudioSaved: '设置已保存',
    lmStudioSaveFailed: '无法保存或连接 LM Studio',
    ...
    onbLocalAi: '本地 AI 通过 LM Studio 运行',
    ...
    onbNote3: 'AI 功能需要正在运行的 LM Studio 服务器。',
    onbBack: '上一步',
  },
  en: {
    ...
    lmStudioEndpointHint: 'LM Studio OpenAI-compatible server address',
    lmStudioModel: 'Model',
    ...
    lmStudioApiToken: 'API token (optional)',
    lmStudioApiTokenHint: 'Only needed when your LM Studio server requires one',
    lmStudioRefresh: 'Refresh',
    lmStudioSaveTest: 'Save & Test',
    lmStudioSaving: 'Saving…',
    lmStudioSaved: 'Settings saved',
    lmStudioSaveFailed: 'Could not save or connect to LM Studio',
    ...
    onbLocalAi: 'Local AI runs through LM Studio',
    ...
    onbNote3: 'AI features require a running LM Studio server.',
    onbBack: 'Back',
  },
  ja: {
    ...
    lmStudioUnreachable: 'LM Studio に接続できません',
    lmStudioOpenSettings: 'ローカル AI 設定を開く',
    setSecLocalAi: 'ローカル AI',
    lmStudioEndpoint: 'サーバー URL',
    lmStudioEndpointHint: 'LM Studio の OpenAI 互換サーバーアドレス',
    lmStudioModel: 'モデル',
    ...
    lmStudioApiToken: 'API トークン（任意）',
    lmStudioApiTokenHint: 'LM Studio サーバーが要求する場合のみ必要です',
    lmStudioRefresh: '更新',
    lmStudioSaveTest: '保存してテスト',
    lmStudioSaving: '保存中…',
    lmStudioSaved: '設定を保存しました',
    lmStudioSaveFailed: 'LM Studio の保存または接続に失敗しました',
    ...
    onbLocalAi: 'ローカル AI は LM Studio で実行されます',
    ...
    onbNote3: 'AI 機能には実行中の LM Studio サーバーが必要です。',
    onbBack: '戻る',
  },
  ko: {
    ...
    lmStudioUnreachable: 'LM Studio에 연결할 수 없습니다',
    lmStudioOpenSettings: '로컬 AI 설정 열기',
    setSecLocalAi: '로컬 AI',
    lmStudioEndpoint: '서버 URL',
    lmStudioEndpointHint: 'LM Studio OpenAI 호환 서버 주소',
    lmStudioModel: '모델',
    ...
    lmStudioApiToken: 'API 토큰(선택 사항)',
    lmStudioApiTokenHint: 'LM Studio 서버에서 요구할 때만 필요합니다',
    lmStudioRefresh: '새로 고침',
    lmStudioSaveTest: '저장 및 테스트',
    lmStudioSaving: '저장 중…',
    lmStudioSaved: '설정이 저장되었습니다',
    lmStudioSaveFailed: 'LM Studio에 저장하거나 연결할 수 없습니다',
    ...
    onbLocalAi: '로컬 AI는 LM Studio를 통해 실행됩니다',
    ...
    onbNote3: 'AI 기능을 사용하려면 LM Studio 서버가 실행 중이어야 합니다.',
    onbBack: '이전',
  },
  fr: {
    ...
    lmStudioUnreachable: 'LM Studio est inaccessible',
    lmStudioOpenSettings: 'Ouvrir les réglages d’IA locale',
    setSecLocalAi: 'IA locale',
    lmStudioEndpoint: 'URL du serveur',
    lmStudioEndpointHint: 'Adresse du serveur compatible OpenAI de LM Studio',
    ...
    lmStudioApiToken: 'Jeton API (facultatif)',
    lmStudioApiTokenHint: 'Nécessaire uniquement si votre serveur LM Studio l’exige',
    ...
    lmStudioSaveFailed: 'Impossible d’enregistrer ou de se connecter à LM Studio',
    ...
    onbLocalAi: 'L’IA locale fonctionne via LM Studio',
    ...
    onbNote3: 'Les fonctions d’IA nécessitent un serveur LM Studio actif.',
    onbBack: 'Retour',
  },
  de: {
    ...
    lmStudioUnreachable: 'LM Studio ist nicht erreichbar',
    lmStudioOpenSettings: 'Lokale KI-Einstellungen öffnen',
    setSecLocalAi: 'Lokale KI',
    lmStudioEndpoint: 'Server-URL',
    lmStudioEndpointHint: 'OpenAI-kompatible Serveradresse von LM Studio',
    ...
    lmStudioApiToken: 'API-Token (optional)',
    lmStudioApiTokenHint: 'Nur erforderlich, wenn der LM Studio-Server es verlangt',
    ...
    lmStudioSaveFailed: 'Speichern oder Verbindung mit LM Studio fehlgeschlagen',
    ...
    onbLocalAi: 'Lokale KI läuft über LM Studio',
    ...
    onbNote3: 'KI-Funktionen benötigen einen laufenden LM Studio-Server.',
    onbBack: 'Zurück',
  },
  es: {
    ...
    lmStudioUnreachable: 'No se puede conectar con LM Studio',
    lmStudioOpenSettings: 'Abrir ajustes de IA local',
    setSecLocalAi: 'IA local',
    lmStudioEndpoint: 'URL del servidor',
    lmStudioEndpointHint: 'Dirección del servidor compatible con OpenAI de LM Studio',
    ...
    lmStudioApiToken: 'Token de API (opcional)',
    lmStudioApiTokenHint: 'Solo se necesita si el servidor LM Studio lo requiere',
    lmStudioRefresh: 'Actualizar',
    lmStudioSaveTest: 'Guardar y probar',
    lmStudioSaving: 'Guardando…',
    lmStudioSaved: 'Ajustes guardados',
    lmStudioSaveFailed: 'No se pudo guardar ni conectar con LM Studio',
    ...
    onbLocalAi: 'La IA local funciona mediante LM Studio',
    ...
    onbNote3: 'Las funciones de IA requieren un servidor LM Studio en ejecución.',
    onbBack: 'Atrás',
  },
  th: {
    ...
    lmStudioUnreachable: 'เชื่อมต่อ LM Studio ไม่ได้',
    lmStudioOpenSettings: 'เปิดการตั้งค่า AI ภายในเครื่อง',
    setSecLocalAi: 'AI ภายในเครื่อง',
    lmStudioEndpoint: 'URL เซิร์ฟเวอร์',
    lmStudioEndpointHint: 'ที่อยู่เซิร์ฟเวอร์ LM Studio ที่รองรับ OpenAI',
    lmStudioModel: 'โมเดล',
    ...
    lmStudioApiToken: 'โทเค็น API (ไม่บังคับ)',
    lmStudioApiTokenHint: 'ต้องใช้เมื่อเซิร์ฟเวอร์ LM Studio กำหนดเท่านั้น',
    lmStudioRefresh: 'รีเฟรช',
    lmStudioSaveTest: 'บันทึกและทดสอบ',
    lmStudioSaving: 'กำลังบันทึก…',
    lmStudioSaved: 'บันทึกการตั้งค่าแล้ว',
    lmStudioSaveFailed: 'บันทึกหรือเชื่อมต่อ LM Studio ไม่ได้',
    ...
    onbLocalAi: 'AI ภายในเครื่องทำงานผ่าน LM Studio',
    ...
    onbNote3: 'ฟีเจอร์ AI ต้องใช้เซิร์ฟเวอร์ LM Studio ที่กำลังทำงาน',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    ...
    lmStudioUnreachable: 'Tidak dapat menjangkau LM Studio',
    lmStudioOpenSettings: 'Buka pengaturan AI lokal',
    setSecLocalAi: 'AI lokal',
    lmStudioEndpoint: 'URL server',
    lmStudioEndpointHint: 'Alamat server LM Studio yang kompatibel dengan OpenAI',
    lmStudioModel: 'Model',
    ...
    lmStudioApiToken: 'Token API (opsional)',
    lmStudioApiTokenHint: 'Hanya diperlukan jika server LM Studio memintanya',
    lmStudioRefresh: 'Segarkan',
    lmStudioSaveTest: 'Simpan & Uji',
    lmStudioSaving: 'Menyimpan…',
    lmStudioSaved: 'Pengaturan disimpan',
    lmStudioSaveFailed: 'Tidak dapat menyimpan atau terhubung ke LM Studio',
    ...
    onbLocalAi: 'AI lokal berjalan melalui LM Studio',
    ...
    onbNote3: 'Fitur AI memerlukan server LM Studio yang aktif.',
    onbBack: 'Kembali',
  },
  ru: {
    ...
    lmStudioUnreachable: 'Не удаётся подключиться к LM Studio',
    lmStudioOpenSettings: 'Открыть настройки локального ИИ',
    setSecLocalAi: 'Локальный ИИ',
    lmStudioEndpoint: 'URL сервера',
    lmStudioEndpointHint: 'Адрес OpenAI-совместимого сервера LM Studio',
    ...
    lmStudioApiToken: 'API-токен (необязательно)',
    lmStudioApiTokenHint: 'Нужен только по требованию сервера LM Studio',
    lmStudioRefresh: 'Обновить',
    lmStudioSaveTest: 'Сохранить и проверить',
    lmStudioSaving: 'Сохранение…',
    lmStudioSaved: 'Настройки сохранены',
    lmStudioSaveFailed: 'Не удалось сохранить или подключиться к LM Studio',
    ...
    onbLocalAi: 'Локальный ИИ работает через LM Studio',
    ...
    onbNote3: 'Для функций ИИ требуется запущенный сервер LM Studio.',
    onbBack: 'Назад',
  },
  ar: {
    ...
    lmStudioApiToken: 'رمز API (اختياري)',
    lmStudioApiTokenHint: 'مطلوب فقط إذا طلبه خادم LM Studio',
    lmStudioRefresh: 'تحديث',
    lmStudioSaveTest: 'حفظ واختبار',
    lmStudioSaving: 'جارٍ الحفظ…',
    lmStudioSaved: 'تم حفظ الإعدادات',
    lmStudioSaveFailed: 'تعذّر الحفظ أو الاتصال بـ LM Studio',
    ...
    onbLocalAi: 'يعمل الذكاء الاصطناعي المحلي عبر LM Studio',
    ...
    onbNote3: 'تتطلب ميزات الذكاء الاصطناعي خادم LM Studio قيد التشغيل.',
    onbBack: 'رجوع',
  },
  pt: {
    ...
    lmStudioUnreachable: 'Não foi possível acessar o LM Studio',
    lmStudioOpenSettings: 'Abrir configurações de IA local',
    setSecLocalAi: 'IA local',
    lmStudioEndpoint: 'URL do servidor',
    lmStudioEndpointHint: 'Endereço do servidor LM Studio compatível com OpenAI',
    lmStudioModel: 'Modelo',
    ...
    lmStudioApiToken: 'Token de API (opcional)',
    lmStudioApiTokenHint: 'Necessário apenas se o servidor LM Studio exigir',
    lmStudioRefresh: 'Atualizar',
    lmStudioSaveTest: 'Salvar e testar',
    lmStudioSaving: 'Salvando…',
    lmStudioSaved: 'Configurações salvas',
    lmStudioSaveFailed: 'Não foi possível salvar ou conectar ao LM Studio',
    ...
    onbLocalAi: 'A IA local funciona pelo LM Studio',
    ...
    onbNote3: 'Os recursos de IA exigem um servidor LM Studio em execução.',
    onbBack: 'Voltar',
  },
  it: {
    ...
    lmStudioUnreachable: 'Impossibile raggiungere LM Studio',
    lmStudioOpenSettings: 'Apri impostazioni IA locale',
    setSecLocalAi: 'IA locale',
    lmStudioEndpoint: 'URL server',
    lmStudioEndpointHint: 'Indirizzo del server LM Studio compatibile con OpenAI',
    ...
    lmStudioApiToken: 'Token API (facoltativo)',
    lmStudioApiTokenHint: 'Necessario solo se richiesto dal server LM Studio',
    lmStudioRefresh: 'Aggiorna',
    lmStudioSaveTest: 'Salva e verifica',
    lmStudioSaving: 'Salvataggio…',
    lmStudioSaved: 'Impostazioni salvate',
    lmStudioSaveFailed: 'Impossibile salvare o connettersi a LM Studio',
    ...
    onbLocalAi: 'L’IA locale funziona tramite LM Studio',
    ...
    onbNote3: 'Le funzioni IA richiedono un server LM Studio in esecuzione.',
    onbBack: 'Indietro',
  },
  pl: {
    ...
    lmStudioUnreachable: 'Nie można połączyć się z LM Studio',
    lmStudioOpenSettings: 'Otwórz ustawienia lokalnej AI',
    setSecLocalAi: 'Lokalna AI',
    lmStudioEndpoint: 'URL serwera',
    lmStudioEndpointHint: 'Adres serwera LM Studio zgodnego z OpenAI',
    lmStudioModel: 'Model',
    ...
    lmStudioApiToken: 'Token API (opcjonalny)',
    lmStudioApiTokenHint: 'Potrzebny tylko, gdy wymaga go serwer LM Studio',
    lmStudioRefresh: 'Odśwież',
    lmStudioSaveTest: 'Zapisz i przetestuj',
    lmStudioSaving: 'Zapisywanie…',
    lmStudioSaved: 'Ustawienia zapisane',
    lmStudioSaveFailed: 'Nie udało się zapisać lub połączyć z LM Studio',
    ...
    onbLocalAi: 'Lokalna AI działa przez LM Studio',
    ...
    onbNote3: 'Funkcje AI wymagają uruchomionego serwera LM Studio.',
    onbBack: 'Wstecz',
  },
  nl: {
    ...
    lmStudioUnreachable: 'LM Studio is niet bereikbaar',
    lmStudioOpenSettings: 'Lokale AI-instellingen openen',
    setSecLocalAi: 'Lokale AI',
    lmStudioEndpoint: 'Server-URL',
    lmStudioEndpointHint: 'OpenAI-compatibel serveradres van LM Studio',
    lmStudioModel: 'Model',
    ...
    lmStudioApiToken: 'API-token (optioneel)',
    lmStudioApiTokenHint: 'Alleen nodig als de LM Studio-server dit vereist',
    lmStudioRefresh: 'Vernieuwen',
    lmStudioSaveTest: 'Opslaan en testen',
    lmStudioSaving: 'Opslaan…',
    lmStudioSaved: 'Instellingen opgeslagen',
    lmStudioSaveFailed: 'Kan niet opslaan of verbinden met LM Studio',
    lmStudioModelLoaded: 'geladen',
    lmStudioModelTools: 'tools',
    ...
    onbLocalAi: 'Lokale AI draait via LM Studio',
    ...
    onbNote3: 'AI-functies vereisen een actieve LM Studio-server.',
    onbBack: 'Terug',
  },
  ms: {
    lmStudioChecking: 'Memeriksa…',
    ...
    lmStudioUnreachable: 'Tidak dapat mencapai LM Studio',
    lmStudioOpenSettings: 'Buka tetapan AI setempat',
    setSecLocalAi: 'AI setempat',
    lmStudioEndpoint: 'URL pelayan',
    lmStudioEndpointHint: 'Alamat pelayan LM Studio yang serasi dengan OpenAI',
    lmStudioModel: 'Model',
    lmStudioModelAuto: 'Pilih model tersedia secara automatik',
    lmStudioModelAutomatic: 'Automatik',
    lmStudioModelManual: 'Manual',
    lmStudioModelRequired: 'Masukkan ID model untuk pemilihan manual.',
    lmStudioApiToken: 'Token API (pilihan)',
    lmStudioApiTokenHint: 'Hanya diperlukan jika pelayan LM Studio memerlukannya',
    lmStudioRefresh: 'Muat semula',
    lmStudioSaveTest: 'Simpan & Uji',
    lmStudioSaving: 'Menyimpan…',
    lmStudioSaved: 'Tetapan disimpan',
    lmStudioSaveFailed: 'Tidak dapat menyimpan atau menyambung ke LM Studio',
    ...
    onbLocalAi: 'AI setempat berjalan melalui LM Studio',
    onbJoinGenTeam: 'Lihat BP-Office di GitHub',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI memerlukan pelayan LM Studio yang sedang berjalan.',
    onbBack: 'Kembali',
  },
  he: {
    ...
    lmStudioUnreachable: 'לא ניתן להגיע אל LM Studio',
    lmStudioOpenSettings: 'פתיחת הגדרות AI מקומי',
    setSecLocalAi: 'AI מקומי',
    lmStudioEndpoint: 'כתובת השרת',
    lmStudioEndpointHint: 'כתובת השרת תואם OpenAI של LM Studio',
    lmStudioModel: 'מודל',
    ...
    lmStudioApiToken: 'אסימון API (אופציונלי)',
    lmStudioApiTokenHint: 'נדרש רק אם שרת LM Studio דורש זאת',
    lmStudioRefresh: 'רענון',
    lmStudioSaveTest: 'שמירה ובדיקה',
    lmStudioSaving: 'שומר…',
    lmStudioSaved: 'ההגדרות נשמרו',
    lmStudioSaveFailed: 'לא ניתן לשמור או להתחבר אל LM Studio',
    ...
    onbLocalAi: 'AI מקומי פועל דרך LM Studio',
    ...
    onbNote3: 'תכונות AI דורשות שרת LM Studio פעיל.',
    onbBack: 'חזרה',
  },
  hi: {
    ...
    lmStudioUnreachable: 'LM Studio तक नहीं पहुँच सका',
    lmStudioOpenSettings: 'स्थानीय AI सेटिंग खोलें',
    setSecLocalAi: 'स्थानीय AI',
    lmStudioEndpoint: 'सर्वर URL',
    lmStudioEndpointHint: 'LM Studio का OpenAI-संगत सर्वर पता',
    lmStudioModel: 'मॉडल',
    ...
    lmStudioApiToken: 'API टोकन (वैकल्पिक)',
    lmStudioApiTokenHint: 'केवल तब आवश्यक जब LM Studio सर्वर माँगे',
    lmStudioRefresh: 'रीफ़्रेश',
    lmStudioSaveTest: 'सहेजें और जाँचें',
    lmStudioSaving: 'सहेजा जा रहा है…',
    lmStudioSaved: 'सेटिंग सहेजी गई',
    lmStudioSaveFailed: 'LM Studio को सहेज या कनेक्ट नहीं किया जा सका',
    ...
    onbLocalAi: 'स्थानीय AI LM Studio के माध्यम से चलता है',
    ...
    onbNote3: 'AI सुविधाओं के लिए LM Studio सर्वर चालू होना चाहिए।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    ...
    lmStudioUnreachable: '無法連線 LM Studio',
    lmStudioOpenSettings: '開啟本機 AI 設定',
    setSecLocalAi: '本機 AI',
    lmStudioEndpoint: '伺服器網址',
    lmStudioEndpointHint: 'LM Studio 的 OpenAI 相容伺服器位址',
    lmStudioModel: '模型',
    lmStudioModelAuto: '自動選擇可用模型',
    lmStudioModelAutomatic: '自動',
    lmStudioModelManual: '手動',
    lmStudioModelRequired: '手動選擇需要輸入模型 ID。',
    lmStudioApiToken: 'API 權杖（選填）',
    lmStudioApiTokenHint: '僅在 LM Studio 伺服器要求時需要',
    lmStudioRefresh: '重新整理',
    lmStudioSaveTest: '儲存並測試',
    lmStudioSaving: '儲存中…',
    lmStudioSaved: '設定已儲存',
    lmStudioSaveFailed: '無法儲存或連線 LM Studio',
    ...
    onbLocalAi: '本機 AI 透過 LM Studio 執行',
    onbJoinGenTeam: '在 GitHub 查看 BP-Office',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能需要正在執行的 LM Studio 伺服器。',
    onbBack: '上一步',
  },
} as const
