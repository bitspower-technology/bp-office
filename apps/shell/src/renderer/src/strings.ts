...
export const strings = {
  zh: {
    ...
    onbTitle1: '欢迎使用 NiuOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'NiuOffice 目前处于 alpha 阶段。欢迎在 GitHub 社区分享反馈，一起塑造它的未来。',
    onbLocalAi: '本地 AI 通过 OpenAI Endpoint 运行',
    onbJoinGenTeam: '在 GitHub 查看 NiuOffice',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to NiuOffice',
    ...
    onbBody2:
      'NiuOffice is still in alpha. Join the NiuOffice community on GitHub to share feedback and help shape what comes next.',
    onbLocalAi: 'Local AI runs through OpenAI Endpoint',
    onbJoinGenTeam: 'View NiuOffice on GitHub',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  fr: {
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans NiuOffice',
    ...
    onbBody2:
      'NiuOffice est encore en alpha. Rejoignez la communauté NiuOffice sur GitHub pour partager vos retours et façonner la suite.',
    onbLocalAi: 'L’IA locale fonctionne via OpenAI Endpoint',
    onbJoinGenTeam: 'Voir NiuOffice sur GitHub',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei NiuOffice',
    ...
    onbBody2:
      'NiuOffice ist noch in der Alpha-Phase. Treten Sie der NiuOffice-Community auf GitHub bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbLocalAi: 'Lokale KI läuft über OpenAI Endpoint',
    onbJoinGenTeam: 'NiuOffice auf GitHub ansehen',
  ...
  es: {
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a NiuOffice',
    ...
    onbBody2:
      'NiuOffice aún está en alfa. Únete a la comunidad de NiuOffice en GitHub para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbLocalAi: 'La IA local funciona mediante OpenAI Endpoint',
    onbJoinGenTeam: 'Ver NiuOffice en GitHub',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ NiuOffice',
    ...
    onbBody2:
      'NiuOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมชุมชน NiuOffice บน GitHub เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbLocalAi: 'AI ภายในเครื่องทำงานผ่าน OpenAI Endpoint',
    onbJoinGenTeam: 'ดู NiuOffice บน GitHub',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di NiuOffice',
    ...
    onbBody2:
      'NiuOffice masih dalam tahap alpha. Bergabunglah dengan komunitas NiuOffice di GitHub untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbLocalAi: 'AI lokal berjalan melalui OpenAI Endpoint',
    onbJoinGenTeam: 'Lihat NiuOffice di GitHub',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в NiuOffice',
    ...
    onbBody2:
      'NiuOffice пока в альфа-версии. Присоединяйтесь к сообществу NiuOffice на GitHub, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbLocalAi: 'Локальный ИИ работает через OpenAI Endpoint',
    onbJoinGenTeam: 'Открыть NiuOffice на GitHub',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في NiuOffice',
    ...
    onbBody2:
      'لا يزال NiuOffice في مرحلة ألفا. انضم إلى مجتمع NiuOffice على GitHub لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbLocalAi: 'يعمل الذكاء الاصطناعي المحلي عبر OpenAI Endpoint',
    onbJoinGenTeam: 'عرض NiuOffice على GitHub',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao NiuOffice',
    ...
    onbBody2:
      'O NiuOffice ainda está em alfa. Participe da comunidade NiuOffice no GitHub para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbLocalAi: 'A IA local funciona pelo OpenAI Endpoint',
    onbJoinGenTeam: 'Ver NiuOffice no GitHub',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in NiuOffice',
    ...
    onbBody2:
      'NiuOffice è ancora in alpha. Unisciti alla community di NiuOffice su GitHub per condividere feedback e contribuire a plasmare il futuro.',
    onbLocalAi: 'L’IA locale funziona tramite OpenAI Endpoint',
    onbJoinGenTeam: 'Vedi NiuOffice su GitHub',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    onbBody2:
      'NiuOffice jest wciąż w fazie alfa. Dołącz do społeczności NiuOffice na GitHubie, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbLocalAi: 'Lokalna AI działa przez OpenAI Endpoint',
    onbJoinGenTeam: 'Zobacz NiuOffice na GitHubie',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  nl: {
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij NiuOffice',
    ...
    onbBody2:
      'NiuOffice is nog in alfa. Word lid van de NiuOffice-community op GitHub om feedback te delen en mee te bepalen wat er komt.',
    onbLocalAi: 'Lokale AI draait via OpenAI Endpoint',
    onbJoinGenTeam: 'Bekijk NiuOffice op GitHub',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke NiuOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'NiuOffice masih dalam peringkat alfa. Sertai komuniti NiuOffice di GitHub untuk berkongsi maklum balas dan membentuk masa depannya.',
  ...
  he: {
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-NiuOffice',
    ...
    onbBody2:
      'NiuOffice עדיין בגרסת אלפא. הצטרפו לקהילת NiuOffice ב-GitHub כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbLocalAi: 'AI מקומי פועל דרך OpenAI Endpoint',
    onbJoinGenTeam: 'הצגת NiuOffice ב-GitHub',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'NiuOffice में आपका स्वागत है',
    ...
    onbBody2:
      'NiuOffice अभी अल्फ़ा में है। GitHub पर NiuOffice समुदाय से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbLocalAi: 'स्थानीय AI OpenAI Endpoint के माध्यम से चलता है',
    onbJoinGenTeam: 'GitHub पर NiuOffice देखें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 NiuOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2:
      'NiuOffice 目前仍在 alpha 階段。歡迎加入 GitHub 上的 NiuOffice 社群，分享回饋，一起打造它的未來。',
