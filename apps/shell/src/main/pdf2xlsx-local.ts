 ...
 * Uses the same lazy PDFium wasm singleton as the Word exporter (shared via
 * ensurePdfium), the same password retry loop, and the pure local conversion pipeline
