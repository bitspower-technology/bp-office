...
const UNSUPPORTED_DOC_RE = /\.(doc|rtf|odt|pptx|ppt|pps|odp|ods|xlsm|xlsb|pages|key|numbers)$/i
 ...
 */
const OPEN_DIALOG_EXTENSIONS = ['docx', 'doc', 'xlsx', 'xls', 'csv', 'pdf', 'md', 'markdown']
