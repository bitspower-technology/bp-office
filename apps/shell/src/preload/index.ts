...
function asLmStudioConfig(result: unknown): LmStudioConfig {
  ...
  throw new Error('Invalid OpenAI Endpoint configuration returned by the main process.')
}
...
function asLmStudioStatus(result: unknown): LmStudioStatus {
  ...
  throw new Error('Invalid OpenAI Endpoint status returned by the main process.')
}
